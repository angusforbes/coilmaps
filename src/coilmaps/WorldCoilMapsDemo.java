 ...
 * @author Angus Forbes
 */
public class WorldCoilMapsDemo extends WorldGeom
{
  //database

  public int MIN_TREE_DEPTH = 8; //12; //12;
  public int MAX_TREE_DEPTH = 8; //12; //12;
  public String DATABASE_URL = "jdbc:mysql://129.0.0.1:3306/ceb";
  public String DATABASE_USERNAME = "ceb";
  public String DATABASE_PASSWORD = "ceb";
  ...
  public static void main(String[] args)
  {
    ...
    WorldGeom world = new WorldCoilMapsDemo();
  ...
  {
//
//    System.out.println("\t\tin setWorldParams()");
//    System.out.println("is properties null??? " + properties);
//    //public final String DATABASE_URL = "jdbc:mysql://10.14.90.83:3306/ceb";
//    this.DATABASE_URL = properties.getProperty("database.url");
//    this.DATABASE_USERNAME = properties.getProperty("database.username");
//    this.DATABASE_PASSWORD = properties.getProperty("database.password");
//
//    System.out.println("setting database params: " + DATABASE_URL +
//      " (username:" + DATABASE_USERNAME + " password: " + DATABASE_PASSWORD + ")");
//
//
//    CebProperties.seaColor = Colorf.newColorRGBString(properties.getProperty("color.ocean"));
//    CebProperties.landColor = Colorf.newColorRGBString(properties.getProperty("color.land"));
//    CebProperties.cityTextColor = Colorf.newColorRGBString(properties.getProperty("color.text"));
//    CebProperties.cityColor = Colorf.newColorRGBString(properties.getProperty("color.dots"));
//    CebProperties.brightLandColor = Colorf.newColorRGBString(properties.getProperty("color.brightland"));
//    CebProperties.CITY_SIZE = Float.parseFloat(properties.getProperty("size.citySize"));
//    CebProperties.CITY_TEXT_SIZE = Float.parseFloat(properties.getProperty("size.cityTextSize"));
  ...
  public void setUpWorld()
  {
    ...
    //database = ConnectorCEBClient.getInstance(DATABASE_URL, DATABASE_USERNAME, DATABASE_PASSWORD);

    //database = ConnectorCEBClient.getInstance(
    //"jdbc:mysql://127.0.0.1:3306/ceb", "ceb", "ceb");

    //database = ConnectorCEBClient.getInstance(
    //"jdbc:mysql://10.14.90.83:3306/ceb", "ceb", "ceb");
  ...
  public void initializeTree()
  {
    ...
    Map<Integer, CityData> cityHash = new HashMap<Integer, CityData>();
          ...
          public void run()
          {
            ...
            //while (true)
            {
              for (int i = 0; i < 10; i++)
              {
                ...
                Utils.sleep(Utils.randomLong(2, 2));
              }
